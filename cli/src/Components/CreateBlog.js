...
class CreateBlog extends Component {
  ...
  constructor(props) {
    ...
    // if(this.props.location.pathname!=='/CreateBlog'){
  ...
  render() {
    const {blog,editorState} = this.state;
    ...
    <Nav className="mr-auto">
      ...
      <div className="container">
        ...
        <form onSubmit={this.onSubmit}>
          ...
          Author<input name="author" type="text" className="form-control" defaultValue={this.state.blog?this.state.blog.author:''}/>
          Image
